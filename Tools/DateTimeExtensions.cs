...
namespace Tools
{
  ...
  {
    public static DateTime GetNextNonHolidayOrWeekendAfter(this DateTime o)
    {
      DateTime target = o;
    ...
    public static bool IsNewYears(this DateTime o)
    {
      ...
      test = AdjustForWeekend(test);
      return test == o || IsDayMonth(o, 1, 1);
    }

    public static DateTime GetNewYears(this DateTime o)
    {
      return AdjustForWeekend(new DateTime(o.Year, 1, 1));
    }


    public static DateTime AdjustForWeekend(this DateTime o)
    {
      switch (o.DayOfWeek)
      {
    ...
    public static bool IsXDayOfMonth(this DateTime o, int month, int day, DayOfWeek dw)
    {
      return o.DayOfWeek == dw && o.Month == month && GetOccurrenceOfDayInMonth(o) == day;
    }
    ...
    public static bool IsMemorialDay(this DateTime o)
    {
      ...
      var nextWeek = o.AddDays(7);
      return o.DayOfWeek == DayOfWeek.Monday && nextWeek.Month == o.Month
        && o.Month == 5;
    }
    ...
    {
      return new DateTime(o.Year, 9, 1).LastDayOfMonth(DayOfWeek.Monday);
    }
    ...
    public static bool Between(this DateTime o, DateTime start, DateTime end)
    {
