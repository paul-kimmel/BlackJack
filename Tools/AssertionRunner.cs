...
//    public void Run<T>(Pair<T> pair, params InlineValidator<Pair<T>>[] tests)
//    {
...
//    public static ValidationResult RunAll<T>(T target, params InlineValidator<T>[] tests)
//    {
//      var o = new AssertionRunner<T>();
//      o.Run(target, tests);
//      return o.Result;
...
//    public void Run<T>(T target, params InlineValidator<T>[] tests)
//    {
//      foreach (var action in tests)
//      {
